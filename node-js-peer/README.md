...
To quickly test a deployed relay address without opening the TUI, use the probe script:
...
- This is the best lightweight validation for direct TCP, AutoTLS/WSS, and optional proxy `443` after a deployment.
